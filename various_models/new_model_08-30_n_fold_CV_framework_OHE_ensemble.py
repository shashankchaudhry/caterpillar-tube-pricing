...
if __name__ == "__main__":
    ...
    classifiers = [(True,buildModelOheRFR),(True,buildModelOheETR)]
    ...
    for j, clf in enumerate(classifiers):
        ...
        for k in range(n_seeds):
            ...
            for i, eval_id in enumerate(all_eval_ids):
                ...
                temp_pred = model.predict(test_arr)
    ...
    print("Blending")
    pickle.dump( dataset_blend_train, open( "./data/pickle/RF_top_5_ensemble_train.pkl", "wb" ) )
    pickle.dump( dataset_blend_test, open( "./data/pickle/RF_top_5_ensemble_test.pkl", "wb" ) )
    clf = SVR()
    ...
    preds.to_csv('./data/results/result_one_hot_08-30-15_ensemble.csv', index=False)
