...
data = data.join(tube_data, on=['tube_assembly_id'], how='outer')
data = data.join(bom_data, on=['tube_assembly_id'], how='outer')
data = data.join(spec_data, on=['tube_assembly_id'], how='outer')
data = data.join(tube_end_form_data, on=['end_a'], how='outer')
data = data.join(tube_end_form_data, on=['end_x'], how='outer', rsuffix='_1')
...
preds.to_csv('./data/results/result_python_R_replica_08-12-15_sub2.csv', index=False)