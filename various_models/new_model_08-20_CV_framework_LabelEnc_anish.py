...
def preprocessData(train_data, eval_data, comp_wts_all):
    ...
    # data['vol_quant'] = data['num_bends']/data['quantity'];
    # data['invtime_qt']=1.0/(2015-data['year']);
    # data['walldia']=data['wall']/data['diameter'];
    # data['qty2']=  pow(data['quantity'],2);
    # data['ytd'] = 2015-data['year'];
    # data['invdia']=pow(data['diameter'],-2);
    # data['dsqL']=pow(data['diameter'],2)/data['length']; 
