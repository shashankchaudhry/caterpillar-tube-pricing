...
def preprocessData(train_data, eval_data, comp_wts_all):
    ...
    for i,col_name in enumerate(all_cols):
        if data_types[i] == object:
            data = simpleMeanEncodeColSingle(data, col_name, 'cost',n_train_rows)
...
def trainModel(train_data, eval_data, train_labels, eval_labels):
    params = {}
...
if __name__ == "__main__":
    ...
    print('training data...')
    trainModel(train_set, eval_set, train_label, eval_cost)
